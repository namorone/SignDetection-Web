...
export function SignLanguageRecognition({ isActive, speed, onTextUpdate }: SignLanguageRecognitionProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      <div className="relative w-full aspect-video bg-black rounded-lg overflow-hidden">
        ...
        {!isWebcamReady && (
          <div className="absolute inset-0 flex items-center justify-center text-white">Loading webcam...</div>
        )}
