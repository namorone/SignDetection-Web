...
export const translations = {
  uk: {
    ...
    teamMember1: "Гошко Богдан",
    teamMember1Role: "Керівник роботи",
    teamMember2: "Боровець Роман",
    teamMember2Role: "Провідний розробник",
    teamMember3: "Процьків Назарій",
    teamMember3Role: "Брав участь в підготовці датасету",
    teamMember4: "Влощак Маркіян",
    teamMember4Role: "Брав участь в підготовці датасету",
    ...
    address: "Адреса",
    addressText: "вул. Університетська, 1, Львів, Україна",
  ...
  en: {
    ...
    teamMember1: "Hoshko Bohdan",
    teamMember1Role: "Head of work",
    teamMember2: "Borovets Roman",
    teamMember2Role: "Lead Developer",
    teamMember3: "Protskiv Nazariy",
    teamMember3Role: "Participated in the preparation of the dataset",
    teamMember4: "Vloschak Markiyan",
    teamMember4Role: "Participated in the preparation of the dataset",
    ...
    address: "Address",
    addressText: "1 Universitetskaya Street, Lviv, Ukraine",
